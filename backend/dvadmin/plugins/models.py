...
class CoreModel(models.Model):
    ...
    modifier =  models.CharField(max_length=255,null=True,blank=True,help_text="修改人Id",verbose_name="修改人Id")
    modifier_id = models.CharField(max_length=255,null=True,blank=True,help_text="修改人",verbose_name="修改人")
